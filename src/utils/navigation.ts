...
const navBarLinks = [
  { name: "Home", url: "/" },
  { name: "Docs", url: "/testsurveilr/docs" },
  { name: "Patterns", url: "/testsurveilr/pattern" },
  { name: "Services", url: "/testsurveilr/services" },
  { name: "Blog", url: "/testsurveilr/blog" },
  { name: "Contact", url: "/testsurveilr/contact" },
];
